 ...
 * Mapeamento de pessoas que interferem nas suas emoções
 */
...
(function() {
    ...
    function setupForm() {
        ...
        // Adicionar uma pessoa inicial
        addPessoa();
        
        // Handler do formulário
        document.getElementById('nucleoInternoForm').addEventListener('submit', handleSubmit);
            ...
            <div class="pessoa-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control pessoa-nome" required 
                               placeholder="Ex: João Silva" oninput="updateResumo()">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Quadrante *</label>
                        <select class="form-select pessoa-quadrante" required onchange="updateResumo()">
                            <option value="">Selecione...</option>
                            <option value="Vítima Natural">😔 Vítima Natural</option>
                            <option value="Vítima Intencional">⚠️ Vítima Intencional</option>
                            <option value="Vingador">⚡ Vingador</option>
                ...
                <div class="mb-3">
                    ...
                    <div class="nivel-info mb-2">
                        <span class="nivel-label">1 = Interfere muito</span>
                        <span class="nivel-label">5 = Interfere pouco</span>
                    </div>
                ...
                <div class="mb-0">
                    ...
                    <textarea class="form-control pessoa-obs" rows="2" 
                              placeholder="Informações adicionais sobre essa pessoa..."></textarea>
                </div>
            </div>
        `;
    ...
    window.updateResumo = function() {
        ...
        // Nível médio
        const nivelMedio = pessoas.length > 0 ? (somaIveis / pessoas.length).toFixed(1) : 0;
    ...
    async function handleSubmit(e) {
        ...
        // Validar se todas as pessoas têm dados completos
        ...
        try {
            console.log('📝 Iniciando salvamento do mapeamento...');
    ...
    function getPessoas() {
        ...
        const pessoasData = pessoas.map(p => ({
            nucleo_interno_id: nucleoInternoId,
            user_id: currentUser.id,
            nome_pessoa: p.nome,
    ...
    window.createPDA = function() {
        ...
        const pdaUrl = `pda.html?from=nucleo-interno&id=${savedProtocolId}`;
    ...
    console.log('✅ Form-nucleo-interno.js inicializado');
